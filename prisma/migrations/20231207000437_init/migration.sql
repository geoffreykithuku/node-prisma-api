-- CreateEnum
CREATE TYPE "UPDATE_STATUS" AS ENUM ('DEPRECATED', 'IN_PROGRESS', 'DONE');
...
-- AddForeignKey
ALTER TABLE "UpdatePoint" ADD CONSTRAINT "UpdatePoint_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
